<template>
  <div>
    <div class="loginpasswordPage" @click="loginpasswordPageClicked">
      <div class="wrap">
        <header>
          <span>欢迎回到&nbsp;ZUO</span>
        </header>
        <div class="login-container">
          ...
          <div class="login-info">
            ...
            <div class="jump">
              <div class="nonum">
                <span  @click="modifyPasswordClicked">忘记密码</span>
              </div>
              <div class="other">
                <span @click="loginPasswordCaptcheClicked">手机验证码登录</span>
              </div>
            </div>
            <div class="submit">
              <button>登录</button>
    ...
    <!--<back-login-captche v-show="tologinCaptcheShow"></back-login-captche>-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods:{
      loginpasswordPageClicked:function () {
        this.$emit('hideGOLoginPasswordComponent');
      }
